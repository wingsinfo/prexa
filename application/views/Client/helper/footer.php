                        ...
                        <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12">
                            ...
                            <div class="footer-middle-text">
                                ...
                                <div class="middle-text">
                                    <p style="text-align: justify">It seeks to address the various challenges surrounding university area by effectively using young intelligent minds for social enrichment</p>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="footer-copyright">
                            <address>Copyright &copy; All Rights Reserved || Develop By: TEST</address>
                            <!--<address>Copyright &copy; <a href="<?php echo base_url(); ?>">Vastra Mela </a>All Rights Reserved || Develop By: <a href="http://quickoninfotech.com/" target="_blank">Quickon Infotech </a></address>-->
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="payment-history">
                            <ul>
                                <!--                                <li><a href="#"><img src="-->
                                <?php //echo base_url();   ?><!--cassets/img/footer/payment.png"-->
                                <!--                                                     alt="payment"></a></li>-->
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-md-12 col-xs-12 col-sm-12">
                        <div class="account-box">
                            ...
                            <a class="forgotLnk" id="fgt" >I can't access my account</a>
...
<div class="modal fade" id="forget-popup" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span
                        class="sr-only">Close</span></button>
                <h3 class="modal-title" id="lineModalLabel">Forget Password</h3>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 col-md-12 col-xs-12 col-sm-12">
                    ...
                    <div class="col-md-12 col-md-12 col-xs-12 col-sm-12">
                        <div class="account-box">
                            <form class="form-signin" method="post">
                                ...
                                <button class="btn btn-lg btn-block purple-bg" onclick="fpass()" type="button">
                                    submit
                                </button>
                            </form>
                            <a class="forgotLnk" id="lgin">Back To Login</a>
                            <div class="or-box row-block">
                                <div class="row">
                                    <div class="col-md-12 row-block">
                                        <a href="<?php echo base_url(); ?>Register" class="btn btn-primary btn-block">
                                            Create New Account
                                        </a>
                                    </div>
                                </div>
...
<div class="mdl" id="demo-1">
    <div class="mdl-container">
        ...
        <div class="col-lg-5 col-md-5 lp">
            <span>Login</span><br>
            <span
                style="font-size:15px;font-family:roboto, 'Rockwell Condensed', 'Roboto Light', leelawadee, 'weblySleek UI Light'">Get access to your Orders, Wishlist and Recommendations</span>
        </div>
