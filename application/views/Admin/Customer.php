...
<html>
    <head>
        ...
        <title>Vastramela ecommerce</title>
        <link type="text/css" rel="stylesheet" href="fonts/css/font-awesome.min.css">
        <link type="text/css" rel="stylesheet" href="fonts/css/material-design-iconic-font.css">
    ...
    <body class="leftbar-view">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12 col-md-12 col-xs-12">
                                            <form>
                                                ...
                                                <div class="form-group col-lg-6 col-md-6 col-sm-9 col-xs-12">
                                                    <label>Pincode*</label>                                        	
                                                    <input type="text" name="pincode" class="form-control" placeholder="Enter phone Here...">
                                                </div>
                                                <div class="form-group col-lg-6 col-md-6 col-sm-9 col-xs-12">
                                                    <label>State*</label>                                        	
                                                    <input type="text" name="state" class="form-control" placeholder="Enter phone Here...">
                                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <div class="footer-left">
                                <span>© 2015 <a href="http://quickoninfotech.com/">QuickoninfoTech</a></span>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
        ...
        <script src="js/j-forms.js"></script>
