    ...
    <div class="topbar-left pull-left">
        <div class="clearfix">
            <ul class="left-branding pull-left clickablemenu ttmenu dark-style menu-color-gradient">
                ...
                <li>
                    <div class="logo">
                        <a href="index.html" title="Admin Template" style="font-size: 35px;"> LOGO</a>
                        <!--<a href="index.html" title="Admin Template"><img src="<?php echo base_url(); ?>Assets/images/logo.png" height="60" width="60" alt="logo"></a>-->
                    </div>
                </li>
            </ul>
